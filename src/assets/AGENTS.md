...
|------|--------|----------|
| `settings-hero-icon.png` | `scripts/generate-app-icon.mjs` | Settings UI hero; About renderer icon (`import.meta.url`); window taskbar icons; coffee-brown aurora palette source |
